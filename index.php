    ...
    <ul class="navbar-nav mr-auto">
     ...
     <li class="nav-item">
	  ...
	  <li class="nav-item" style="position:absolute;right:10px;top:2px">
	   <button class="button" onclick="location.href='login.php';" style="width:auto;">Login</button>
	  </li>
    </ul>
  </div>
</nav>
<br>
  ...
  <div class="carousel-inner">
	...
	<div class="parent d-flex justify-content-center">
      <img src="images/poza1.1.jpg" alt="Poza Marseille" width="600" height="400">
	  </div>
    </div>
    <div class="carousel-item">
	<div class="parent d-flex justify-content-center">
      <img src="images/poza4.jpg" alt="Poza Viena Zoo" width="600" height="400">
	  </div>
    </div>
	  <div class="carousel-item">
	<div class="parent d-flex justify-content-center">
      <img src="images/poza5.jpg" alt="Poza Viena Zoo" width="600" height="400">
	  </div>
    </div>
  </div>
  ...
  <a class="carousel-control-next" href="#carouselExampleIndicators" role="button" data-slide="next">
    ...
    <span class="sr-only">Next</span>
      ...
      <h1>De ce noi?</h1>
	  <br>
	<p class="text1" style="color:#5a5a85">Pentru ca Break Free e mai mult decat o simpla agentie de turism.Este locul unde se leaga cele mai frumoase prietenii,iar momentele alaturi de noi sunt de neuitat.Just break free!</p>
	</section>
	<br>
	<br>
	<br>
